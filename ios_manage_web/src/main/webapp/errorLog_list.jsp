				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="${pageContext.request.contextPath}/log/all?pageNum=${logs.pageNum-1}&pageSize=${logs.pageSize}">上一页</a></li>
							<c:forEach begin="1" end="${logs.pages}" step="1" var="i">
								<c:if test="${i == logs.pageNum}">
									<li class="active"><a href="${pageContext.request.contextPath}/log/all?pageNum=${i}&pageSize=${logs.pageSize}">${i}</a></li>
								</c:if>
								<c:if test="${i != logs.pageNum}">
									<li><a href="${pageContext.request.contextPath}/log/all?pageNum=${i}&pageSize=${logs.pageSize}">${i}</a></li>
								</c:if>
							</c:forEach>
							<li><a href="${pageContext.request.contextPath}/log/all?pageNum=${logs.pageNum+1}&pageSize=${logs.pageSize}">下一页</a></li>
							<li>
